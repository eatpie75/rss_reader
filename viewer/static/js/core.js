...
(function() {
  ...
  FeedManager = (function() {
    ...
    FeedManager.prototype.update_unread = function(data, feed) {
      var category, id, tmp, _i, _j, _len, _len1, _ref;
      if (feed == null) {
        feed = null;
      }
      if (feed != null) {
    ...
    FeedManager.prototype.render_feed_list = function() {
      var category, feed, render, used_categories, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
      render = "";
      ...
      for (_i = 0, _len = used_categories.length; _i < _len; _i++) {
        category = used_categories[_i];
        ...
        _ref = this.feeds.get_by_category(category.pk);
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          feed = _ref[_j];
          render += Mark.up(window.template_includes.feed_row, feed);
        }
      }
      _ref1 = this.feeds.get_all_without_category();
  ...
  FeedList = (function() {
    ...
    FeedList.prototype.get_used_categories = function() {
      var feed, list, _i, _len, _ref, _ref1;
      list = [];
      _ref = this.get_all_with_category();
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        feed = _ref[_i];
        if (_ref1 = feed.category, __indexOf.call(list, _ref1) < 0) {
    ...
    FeedList.prototype.get_unread_for_category = function(category) {
      var feed, unread, _i, _len, _ref;
      unread = 0;
      _ref = this.get_by_category(category);
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        feed = _ref[_i];
        unread += feed.unread;
      }
