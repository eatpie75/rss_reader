...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.success'
        db.add_column(u'feeds_feed', 'success',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Feed.last_error'
        db.add_column(u'feeds_feed', 'last_error',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.success'
        db.delete_column(u'feeds_feed', 'success')

        # Deleting field 'Feed.last_error'
        db.delete_column(u'feeds_feed', 'last_error')
