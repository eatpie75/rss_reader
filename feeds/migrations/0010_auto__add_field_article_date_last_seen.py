...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.date_last_seen'
        db.add_column(u'feeds_article', 'date_last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 20, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.date_last_seen'
        db.delete_column(u'feeds_article', 'date_last_seen')
