...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserFeedSubscription.category'
        db.add_column(u'feeds_userfeedsubscription', 'category',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserFeedSubscription.category'
        db.delete_column(u'feeds_userfeedsubscription', 'category_id')
