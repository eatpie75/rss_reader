...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # db.rename_column(u'feeds_userarticleinfo', 'feed_id', 'old_feed')
        db.add_column(u'feeds_userarticleinfo', 'feed_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['feeds.UserFeedSubscription']),
                      keep_default=False)
        # for article in UserArticleInfo.objects.all():
        #     print(article.article)
        #     old_feed=Feed.objects.get(pk=article.feed_id)
        #     print(old_feed)
        #     new_feed=UserFeedSubscription.objects.get(feed=old_feed, user=article.user)
        #     print(new_feed)
