...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.read'
        db.delete_column(u'feeds_article', 'read')

        # Adding unique constraint on 'UserArticleInfo', fields ['user', 'feed', 'article']
        db.create_unique(u'feeds_userarticleinfo', ['user_id', 'feed_id', 'article_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserArticleInfo', fields ['user', 'feed', 'article']
        db.delete_unique(u'feeds_userarticleinfo', ['user_id', 'feed_id', 'article_id'])

        # Adding field 'Article.read'
        db.add_column(u'feeds_article', 'read',
