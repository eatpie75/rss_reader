...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feeds_article', 'url', self.gf('django.db.models.fields.URLField')(max_length=500))

        # Changing field 'Feed.feed_url'
        db.alter_column(u'feeds_feed', 'feed_url', self.gf('django.db.models.fields.URLField')(max_length=500))

        # Changing field 'Feed.site_url'
        db.alter_column(u'feeds_feed', 'site_url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Article.url'
        db.alter_column(u'feeds_article', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Feed.feed_url'
        db.alter_column(u'feeds_feed', 'feed_url', self.gf('django.db.models.fields.URLField')(max_length=200))
