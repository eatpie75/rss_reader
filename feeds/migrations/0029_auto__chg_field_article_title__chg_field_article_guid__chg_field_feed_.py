...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feeds_article', 'title', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Article.guid'
        db.alter_column(u'feeds_article', 'guid', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Feed.title'
        db.alter_column(u'feeds_feed', 'title', self.gf('django.db.models.fields.TextField')())

        # Changing field 'UserFeedSubscription.title'
        db.alter_column(u'feeds_userfeedsubscription', 'title', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Article.title'
        db.alter_column(u'feeds_article', 'title', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Article.guid'
        db.alter_column(u'feeds_article', 'guid', self.gf('django.db.models.fields.CharField')(max_length=500))
