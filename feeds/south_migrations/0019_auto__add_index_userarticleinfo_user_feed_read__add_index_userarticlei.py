...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserArticleInfo', fields ['user', 'feed', 'read']
        db.create_index(u'feeds_userarticleinfo', ['user_id', 'feed_id', 'read'])

        # Adding index on 'UserArticleInfo', fields ['user', 'feed']
        db.create_index(u'feeds_userarticleinfo', ['user_id', 'feed_id'])


    def backwards(self, orm):
        # Removing index on 'UserArticleInfo', fields ['user', 'feed']
        db.delete_index(u'feeds_userarticleinfo', ['user_id', 'feed_id'])

        # Removing index on 'UserArticleInfo', fields ['user', 'feed', 'read']
        db.delete_index(u'feeds_userarticleinfo', ['user_id', 'feed_id', 'read'])
