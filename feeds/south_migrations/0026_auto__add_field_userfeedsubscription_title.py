...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFeedSubscription.title'
        db.add_column(u'feeds_userfeedsubscription', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
        for feed in orm.UserFeedSubscription.objects.all():
            feed.title=feed.feed.title
            feed.save()


    def backwards(self, orm):
        # Deleting field 'UserFeedSubscription.title'
        db.delete_column(u'feeds_userfeedsubscription', 'title')
