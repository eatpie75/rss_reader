...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feeds_article', 'description', self.gf('django.db.models.fields.TextField')(default=''))
        db.commit_transaction()

        # Changing field 'Article.author'
        db.start_transaction()
        db.alter_column(u'feeds_article', 'author', self.gf('django.db.models.fields.CharField')(default='', max_length=250))
        db.commit_transaction()

        # Changing field 'Article.content'
        db.start_transaction()
        db.alter_column(u'feeds_article', 'content', self.gf('django.db.models.fields.TextField')(default=''))
        db.commit_transaction()

        # Changing field 'Feed.title'
        db.start_transaction()
        db.alter_column(u'feeds_feed', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
        db.commit_transaction()

        # Changing field 'Feed.last_error'
        db.start_transaction()
        db.alter_column(u'feeds_feed', 'last_error', self.gf('django.db.models.fields.CharField')(default='', max_length=500))
        db.commit_transaction()

        # Changing field 'UserFeedCache.unread'
        db.start_transaction()
        db.alter_column(u'feeds_userfeedcache', 'unread', self.gf('django.db.models.fields.PositiveIntegerField')())
        db.commit_transaction()
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Article.author'
        db.alter_column(u'feeds_article', 'author', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Article.content'
        db.alter_column(u'feeds_article', 'content', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Feed.title'
        db.alter_column(u'feeds_feed', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Feed.last_error'
        db.alter_column(u'feeds_feed', 'last_error', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'UserFeedCache.unread'
        db.alter_column(u'feeds_userfeedcache', 'unread', self.gf('django.db.models.fields.IntegerField')())
