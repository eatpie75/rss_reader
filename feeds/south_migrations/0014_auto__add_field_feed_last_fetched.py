...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.last_fetched'
        db.add_column(u'feeds_feed', 'last_fetched',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        for feed in orm.Feed.objects.all():
            if feed.last_fetched==None:
                feed.last_fetched=feed.last_updated
                feed.save()


    def backwards(self, orm):
        # Deleting field 'Feed.last_fetched'
        db.delete_column(u'feeds_feed', 'last_fetched')
