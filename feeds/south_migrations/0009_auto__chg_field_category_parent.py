...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feeds_category', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feeds.Category'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Category.parent'
        raise RuntimeError("Cannot reverse this migration. 'Category.parent' and its values cannot be restored.")
