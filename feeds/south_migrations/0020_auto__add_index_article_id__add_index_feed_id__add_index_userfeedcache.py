...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Article', fields ['id']
        db.create_index(u'feeds_article', ['id'])

        # Adding index on 'Feed', fields ['id']
        db.create_index(u'feeds_feed', ['id'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Feed', fields ['id']
        db.delete_index(u'feeds_feed', ['id'])

        # Removing index on 'Article', fields ['id']
        db.delete_index(u'feeds_article', ['id'])
