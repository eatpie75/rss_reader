...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserFeedCache', fields ['user', 'feed']
        db.create_unique(u'feeds_userfeedcache', ['user_id', 'feed_id'])


        # Changing field 'UserFeedSubscription.date_added'
        db.alter_column(u'feeds_userfeedsubscription', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding unique constraint on 'UserFeedSubscription', fields ['user', 'feed']
        db.create_unique(u'feeds_userfeedsubscription', ['user_id', 'feed_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserFeedSubscription', fields ['user', 'feed']
        db.delete_unique(u'feeds_userfeedsubscription', ['user_id', 'feed_id'])

        # Removing unique constraint on 'UserFeedCache', fields ['user', 'feed']
        db.delete_unique(u'feeds_userfeedcache', ['user_id', 'feed_id'])


        # Changing field 'UserFeedSubscription.date_added'
        db.alter_column(u'feeds_userfeedsubscription', 'date_added', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'feeds.userfeedsubscription': {
            'Meta': {'unique_together': "[['user', 'feed']]", 'object_name': 'UserFeedSubscription'},
